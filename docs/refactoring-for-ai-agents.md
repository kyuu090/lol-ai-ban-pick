...
- TypeScript 化を進める場合は @docs/ts-magiration/README.md から対象 Phase の計画を読む。目的は型安全化そのものではなく、生成AIが読む文脈を減らすこと。TypeScript 作業の証跡は @docs/ts-magiration/save-data/ 配下へ残す。
